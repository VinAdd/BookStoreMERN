  ...
  return (
    <div className="p-4">
      <div className=" flex items-center justify-center ">
        <h1 className='text-3xl font-bold text-center text-red-600 my-4'>Books List</h1>
        <Link to="/books/create">
          <MdOutlineAddBox className="absolute top-4 right-4 text-3xl text-blue-600 cursor-pointer" />
        </Link>
      </div>
      {loading ? (
        <Spinner />
